 ...
 */
class DocumentateMetaBoxRoleTest extends WP_UnitTestCase {
	 ...
	 */
	public function test_management_sees_both_groups_with_heading() {
		...
		$object_row = strpos( $html, 'documentate-field-objeto' );
		$heading = strpos( $html, 'documentate-seccion-rol' );
		$number_pos = strpos( $html, 'documentate-field-numero_resolucion' );
		$services = strpos( $html, 'documentate-field-servicios' );
		$this->assertLessThan( $heading, $object_row, 'Área rows come before the heading.' );
		$this->assertLessThan( $number_pos, $heading, 'Gestión rows come after the heading.' );
		$this->assertLessThan( $services, $heading );
	 ...
	 */
	public function test_admin_sees_the_management_group() {
	 ...
	 */
	public function test_area_does_not_see_management_rows_nor_their_values() {
	 ...
	 */
	public function test_area_with_only_management_fields_gets_no_table() {
