 ...
 */
class DocumentateAppDetalleRolTest extends WP_UnitTestCase {
	 ...
	 */
	public function test_area_does_not_see_the_gestion_fields() {
		wp_set_current_user( $this->area_id );

		$html = Documentate_App_Detalle::render( $this->doc_id );
	 ...
	 */
	public function test_gestion_sees_the_gestion_fields() {
