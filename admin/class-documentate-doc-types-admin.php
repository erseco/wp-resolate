...
class Documentate_Doc_Types_Admin {
	...
	public function add_fields() {
		...
		<div class="form-field">
			<label for="<?php echo esc_attr( Documentate_Pdf_Layout::META_KEY ); ?>"><?php echo esc_html( 'Maqueta PDF' ); ?></label>
	...
	public function edit_fields( $term, $taxonomy ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		...
		<tr class="form-field">
			<th scope="row"><label for="<?php echo esc_attr( Documentate_Pdf_Layout::META_KEY ); ?>"><?php echo esc_html( 'Maqueta PDF' ); ?></label></th>
			<td>
