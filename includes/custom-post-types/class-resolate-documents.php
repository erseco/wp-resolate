	...
	public function filter_post_data_compose_content( $data, $postarr ) {
		...
		if ( empty( $schema ) ) {
			$schema = array(
				array(
					'slug' => 'objeto',
					'label' => __( 'Objeto', 'resolate' ),
					'type' => 'rich',
				),
				array(
					'slug' => 'antecedentes',
					'label' => __( 'Antecedentes', 'resolate' ),
					'type' => 'rich',
				),
				array(
					'slug' => 'fundamentos',
					'label' => __( 'Fundamentos de derecho', 'resolate' ),
					'type' => 'rich',
				),
				array(
					'slug' => 'dispositivo',
					'label' => __( 'Parte dispositiva (Resuelvo)', 'resolate' ),
					'type' => 'rich',
				),
				array(
					'slug' => 'firma',
					'label' => __( 'Firma / Pie', 'resolate' ),
					'type' => 'rich',
				),
			);
		}
